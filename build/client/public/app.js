...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vuePolyglot = __webpack_require__(4);
	
	var _vuePolyglot2 = _interopRequireDefault(_vuePolyglot);
	...
	_vue2.default.use(_vuePolyglot2.default, { context: window.context || 'cozy' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodePolyglot = __webpack_require__(5);
	...
	var init = function init(_ref) {
	  ...
	  if (lang && lang != 'en') {
	    try {
	      var dict = __webpack_require__(20)("./" + lang);
	  ...
	  if (context) {
	    try {
	      var _dict = __webpack_require__(25)("./" + context + '/locales/' + lang);
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"category host_provider": "Hébergeur",
		"category productivity": "Productivité",
		"category health": "Santé",
		"category social": "Social",
		"category transport": "Voyage et transport",
		...
		"my_accounts discovery title": "Découvrir",
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"loginUrl": "Log-in URL",
		"category telecom": "Telecom",
		"category isp": "Internet Provider",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./cozy/assets/img/facture-telephonique-lg.jpg": 26,
		"./cozy/index": 27,
		"./cozy/index.json": 27,
		"./cozy/locales/de": 28,
		"./cozy/locales/de.json": 28,
		"./cozy/locales/en": 29,
		"./cozy/locales/en.json": 29,
		"./cozy/locales/fr": 30,
		"./cozy/locales/fr.json": 30,
		"./cozy/locales/nl": 31,
		"./cozy/locales/nl.json": 31,
		"./cozy/locales/sq": 32,
		"./cozy/locales/sq.json": 32
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
	};
...
/***/ function(module, exports) {
	...
	module.exports = {
		"use-case phone-bills title": "Haal jouw telefoonrekening op",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _discovery_list = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/discovery_list\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _discovery_list2 = _interopRequireDefault(_discovery_list);
	
	var _category_list = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/category_list\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _category_list2 = _interopRequireDefault(_category_list);
	
	var _connected_list = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./components/connected_list\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _connected_list2 = _interopRequireDefault(_connected_list);
	...
	exports.default = [{
	  name: 'categoryList',
	  path: '/category',
	  component: _category_list2.default
	}, {
	  name: 'discoveryList',
	  path: '/discovery',
	  component: _discovery_list2.default
	}, {
	  name: 'connectedList',
	  path: '/connected',
	  component: _connected_list2.default
	}, {
	  name: 'default',
	  path: '/',
	  redirect: '/discovery'
